...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[calc(100%-1.5rem)] max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[1.75rem] border border-border/70 bg-card/95 p-6 shadow-2xl shadow-slate-950/15 duration-200 sm:w-full",
        className,
      )}
      {...props}
    >
